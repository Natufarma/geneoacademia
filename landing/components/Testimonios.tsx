...
export default function Testimonios() {
  return (
    <section className="md:sticky md:top-0 z-[20] min-h-0 md:min-h-[100svh] flex flex-col justify-center bg-surface py-10 sm:py-12">
      <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        {/* Cards deslizables en una fila con scroll horizontal. snap-mandatory +
          ...
          {testimonios.slice(0, 6).map((t, i) => (
            <Reveal key={t.nombre} delay={i * 0.08} className="snap-start snap-always shrink-0 w-[80%] sm:w-[340px] lg:w-[360px]" blur={8}>
              <div className="h-full bg-white rounded-3xl shadow-soft p-6 sm:p-8 hover:shadow-card hover:-translate-y-1 active:shadow-card active:-translate-y-1 transition-all duration-300 flex flex-col">
                ...
                <p className="text-ink text-base italic leading-relaxed mt-4 flex-1 line-clamp-6">
                  &ldquo;{t.cita}&rdquo;
                </p>
