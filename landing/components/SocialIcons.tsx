/**
 * Íconos de marca oficiales (SVG inline). lucide-react ya no exporta íconos de
 * redes sociales, así que los sustitutos genéricos (Globe/Music/Send) eran
 * engañosos. Estos son los glifos reales de cada red.
 */
